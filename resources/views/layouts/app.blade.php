        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                    @auth
                        <a href="{{ route('tasks.index') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm font-semibold {{ request()->routeIs('tasks.*') ? 'text-indigo-600 bg-indigo-50/70 border border-indigo-100' : 'text-slate-700 hover:text-indigo-600 hover:bg-slate-50' }} rounded-xl transition-colors">
                        ...
                        <a href="{{ route('courses.index') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm font-semibold {{ request()->routeIs('courses.*') ? 'text-indigo-600 bg-indigo-50/70 border border-indigo-100' : 'text-slate-700 hover:text-indigo-600 hover:bg-slate-50' }} rounded-xl transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
